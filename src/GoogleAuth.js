...
module.exports = {
     ...
     * @param callback(function)  Callback The callback to call with the authorized client.
     *                            Params of callback will be reference to the google sheets
     *                            API, and args json object
     * @param args                Arguments to pass into callback
     */
    authorizeSpreadsheets : function(callback, args) 
    {
...
function getNewToken(oAuth2Client, callback, args)
{
    ...
    rl.question('Enter the code from that page here: ', (code) => 
    {
        ...
        oAuth2Client.getToken(code, (err, token) => 
        {
            ...
            callback(google.sheets(oAuth2Client, args))
        });
    });
}